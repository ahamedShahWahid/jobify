"""Admin user moderation — suspend / unsuspend + the audit-log viewer.

Layer order per CLAUDE.md error-ladder convention: current_user → 401 invariants
(done by the dep) → _require_admin → 403 not_an_admin → DB read for the target.
"""
...
from jobify.db.models import AuditLog, User
