...
def downgrade() -> None:
    op.drop_index("ix_resumes_applicant_id", table_name="resumes", schema="jobify")
    op.drop_table("resumes", schema="jobify")
    op.execute("DROP TYPE IF EXISTS jobify.resume_parse_status")
