# api/src/jobify/db/migrations/versions/0016_user_suspension.py
...
def downgrade() -> None:
    op.drop_column("users", "suspension_reason", schema="jobify")
    op.drop_column("users", "suspended_at", schema="jobify")
