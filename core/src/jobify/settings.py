...
class Settings(BaseSettings):
    ...
    match_surface_threshold: float = Field(
        ...
        ge=0.0,
        le=1.0,
        alias="JOBIFY_MATCH_SURFACE_THRESHOLD",
    ...
    match_explainer_model: str = Field(
        ...
        alias="JOBIFY_MATCH_EXPLAINER_MODEL",
